...
public class SistemaDeReservas {
    ...
    public List<Reserva> listarReservasPorPassageiro(Passageiro passageiro) {
        List<Reserva> reservasDoPassageiro = new ArrayList<>();
        for (Reserva reserva : reservas) {
            if (reserva.getPassageiro().equals(passageiro)) {
                reservasDoPassageiro.add(reserva);
            }
        }
        return reservasDoPassageiro;
    }
